...
if pagamento == 1:
    ...
    print('O Valor do Produto Ficará R$ {:.2f} à Vista no Cartão de Crédito.'.format(cartão))
    ...
    if parcelas >= 3:
        ...
        print('O Valor do Produto Ficará R$ {:.2f} à Vista no Cartão.'.format(cartão))
